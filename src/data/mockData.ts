...
export const mockAnalysisData = {
  analyst_signals: {
    ben_graham_agent: {
      AAPL: {
        confidence: 50.0,
        reasoning: "While AAPL shows stable earnings with positive EPS historically, the lack of growth and high debt ratio raises concerns. The significant negative margin of safety indicates that the current price is above intrinsic value, suggesting limited upside potential.",
        signal: "neutral"
      }
    },
    bill_ackman_agent: {
      AAPL: {
        confidence: 60.0,
        reasoning: "While Apple (AAPL) exhibits strong operating margins and high ROE, the lack of significant revenue growth and high debt levels raise concerns about its long-term sustainability. Additionally, the substantial negative margin of safety suggests that the stock is significantly overvalued compared to its intrinsic value. Hence, the investment outlook is bearish under current conditions.",
        signal: "bearish"
      }
    },
    cathie_wood_agent: {
      AAPL: {
        confidence: 65.0,
        reasoning: "While AAPL exhibits positive operating leverage and decent investment in R&D, its valuation indicates a significant margin of safety issue with a market cap exceeding intrinsic value by over 30%. The growth potential appears limited in the current market conditions, resulting in a bearish outlook.",
        signal: "bearish"
      }
    },
    ...
    sentiment_agent: {
      AAPL: {
        confidence: 58.0,
        reasoning: "Weighted Bullish signals: 120.9, Weighted Bearish signals: 201.9",
        signal: "bearish"
      }
    },
    stanley_druckenmiller_agent: {
      AAPL: {
        confidence: 60.0,
        reasoning: "Despite strong revenue and EPS growth, negative price momentum, insider selling, high valuations, and high leverage present significant risks. The overall signal is neutral due to the mixed indicators, warranting caution in investment.",
        signal: "neutral"
      }
    },
    ...
    valuation_agent: {
      AAPL: {
        ...
        reasoning: {
          dcf_analysis: {
            details: "Intrinsic Value: $1,384,683,782,101.15, Market Cap: $3,863,453,200,570.00, Gap: -64.2%",
            signal: "bearish"
          },
          owner_earnings_analysis: {
            details: "Owner Earnings Value: $467,980,442,527.33, Market Cap: $3,863,453,200,570.00, Gap: -87.9%",
            signal: "bearish"
          }
        },
        signal: "bearish"
  ...
  decisions: {
    AAPL: {
      ...
      confidence: 50.0,
      quantity: 0,
      reasoning: "Despite the bullish signal from the fundamentals agent, the overwhelming bearish signals from valuation, sentiment, and multiple other agents indicate a lack of confidence in taking a long position. Therefore, I will not take action on AAPL."
    }
  }
};